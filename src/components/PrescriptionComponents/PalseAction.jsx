...
const TemperatureAction = ({ id, handleAction }) => {
  const [open, setOpen] = useState(false);
  ...
  return (
    <View>
      ...
      <Modal visible={open} animationType="slide" transparent={true}>
        <View style={styles.modalContainer}>
          <ActionForm id={id} type="temperature" handleClose={handleClose} handleAction={handleAction} />
        </View>
      </Modal>
    </View>
  );
...
const BloodPressureAction = ({ id, handleAction }) => {
  const [open, setOpen] = useState(false);
  ...
  return (
    <View>
      ...
      <Modal visible={open} animationType="slide" transparent={true}>
        <View style={styles.modalContainer}>
          <ActionForm id={id} type="blood_pressure" handleClose={handleClose} handleAction={handleAction} />
        </View>
      </Modal>
    </View>
  );
...
const PulseAction = ({ id, handleAction }) => {
  const [open, setOpen] = useState(false);
  ...
  return (
    <View>
      ...
      <Modal visible={open} animationType="slide" transparent={true}>
        <View style={styles.modalContainer}>
          <ActionForm id={id} type="pulse" handleClose={handleClose} handleAction={handleAction} />
        </View>
      </Modal>
    </View>
  );
...
export { DoctorHeader, PatientHeader, ActionForm, ProblemAction, TemperatureAction, BloodPressureAction, PulseAction };
